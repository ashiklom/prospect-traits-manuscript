...
PROSPECT has been used extensively for the simulation of leaf and, (combined with canopy models) canopy reflectance, as well as for estimation of leaf spectral characteristics through spectral inversion~\cite{jacquemoud_2009_prosail}.
